...
class DisplayTemperatureUnitStrategyFahrenheit(private val application: Application)
    : DisplayTemperatureUnitStrategy {
    override fun getTextIdShowTea(temperature: Int): String {
        return application.getString(R.string.show_tea_display_fahrenheit,
            getFormattedTemperature(temperature))
    }

    override fun getTextNewTea(temperature: Int): String {
        return application.getString(R.string.new_tea_edit_text_temperature_text_fahrenheit,
            getFormattedTemperature(temperature))
    }
}