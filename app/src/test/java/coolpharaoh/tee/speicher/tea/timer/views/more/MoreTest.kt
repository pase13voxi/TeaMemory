...
class MoreTest {
    ...
    fun expectMoreListAndVersion() {
        moreActivityScenario!!.onActivity { more: More ->
            ...
            Assertions.assertThat(moreRecyclerView.adapter!!.itemCount).isEqualTo(6)
            moreRecyclerView.scrollToPosition(0)
            Shadows.shadowOf(Looper.getMainLooper()).idle()
            checkHeaderAndPositionAtPositionInRecyclerView(
                moreRecyclerView,
                0,
                more.getString(R.string.more_contact_heading),
                more.getString(R.string.more_contact_description)
            )
            ...
            checkHeaderAndPositionAtPositionInRecyclerView(
                moreRecyclerView,
                1,
                more.getString(R.string.more_rating_heading),
                more.getString(R.string.more_rating_description)
            )
            ...
            checkHeaderAndPositionAtPositionInRecyclerView(
                moreRecyclerView,
                2,
                more.getString(R.string.more_statistics_heading),
                more.getString(R.string.more_statistics_description)
            )
            ...
            checkHeaderAndPositionAtPositionInRecyclerView(
                moreRecyclerView,
                3,
                more.getString(R.string.more_export_import_heading),
                more.getString(R.string.more_export_import_description)
            )
            ...
            checkHeaderAndPositionAtPositionInRecyclerView(
                moreRecyclerView,
                4,
                more.getString(R.string.more_software_heading),
                more.getString(R.string.more_software_description)
            )
            ...
            checkHeaderAndPositionAtPositionInRecyclerView(
                moreRecyclerView,
                5,
                more.getString(R.string.more_privacy_heading),
                more.getString(R.string.more_privacy_description)
            )
            val textViewVersion = more.findViewById<TextView>(R.id.text_view_more_version)
            Assertions.assertThat(textViewVersion.text)
                .isEqualTo(more.getString(R.string.more_version, BuildConfig.VERSION_NAME))
        }
    }
    ...
    fun navigateToContact() {
        ...
        moreActivityScenario!!.onActivity { more: More ->
            ...
            val actual =
                Shadows.shadowOf(ApplicationProvider.getApplicationContext<Context>() as Application).nextStartedActivity
            Assertions.assertThat(actual.component).isEqualTo(expected.component)
        }
    }
    ...
    fun navigateToRating() {
        ...
        moreActivityScenario!!.onActivity { more: More ->
            ...
            val expected =
                Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=" + more.packageName))
            val actual =
                Shadows.shadowOf(ApplicationProvider.getApplicationContext<Context>() as Application).nextStartedActivity
    ...
    fun navigateToPrivacyPolicy() {
        ...
        moreActivityScenario!!.onActivity { more: More ->
            ...
            val expected = Intent(
                Intent.ACTION_VIEW,
                Uri.parse(more.getString(R.string.more_privacy_policy_url))
            )
            val actual =
                Shadows.shadowOf(ApplicationProvider.getApplicationContext<Context>() as Application).nextStartedActivity
            Assertions.assertThat(actual.data).isEqualTo(expected.data)
