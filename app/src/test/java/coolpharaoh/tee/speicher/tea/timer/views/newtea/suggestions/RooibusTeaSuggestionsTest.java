...
public class RooibusTeaSuggestionsTest {
    ...
    public void getAmountTsHint() {
        ...
        when(resources.getIntArray(R.array.suggestions_rooibus_tea_amount_ts)).thenReturn(arrayTs);
    ...
    public void getAmountGrHint() {
        ...
        when(resources.getIntArray(R.array.suggestions_rooibus_tea_amount_gr)).thenReturn(arrayGr);
    ...
    public void getTemperatureCelsiusHint() {
        ...
        when(resources.getIntArray(R.array.suggestions_rooibus_tea_temperature_celsius)).thenReturn(arrayCelsius);
    ...
    public void getTemperatureFahrenheitHint() {
        ...
        when(resources.getIntArray(R.array.suggestions_rooibus_tea_temperature_fahrenheit)).thenReturn(arrayFahrenheit);
    ...
    public void getSteepingTimeHint() {
        ...
        when(resources.getStringArray(R.array.suggestions_rooibus_tea_time)).thenReturn(arrayTime);
