...
internal class RecyclerItemsHeaderStrategyDefaultTest {
    @MockK
    ...
    fun generateRecyclerItemsHeader() {
        ...
        val recyclerItemsHeader: RecyclerItemsHeaderStrategy = RecyclerItemsHeaderStrategyDefault(application)
