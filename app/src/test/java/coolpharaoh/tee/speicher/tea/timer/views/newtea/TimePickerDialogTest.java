...
public class TimePickerDialogTest {
    ...
    public void showDialogAndExpectTitle() {
        ...
        assertThat(shadowDialog.getTitle()).isEqualTo(dialogFragment.getString(R.string.newtea_dialog_time_header));
    }
    ...
    public void clickSuggestionAndExpectShownSuggestion() {
        ...
        final NumberPicker numberPickerMinutes = dialog.findViewById(R.id.number_picker_dialog_time_minutes);
        assertThat(numberPickerMinutes.getValue()).isEqualTo(2);

        final NumberPicker numberPickerSeconds = dialog.findViewById(R.id.number_picker_dialog_time_seconds);
