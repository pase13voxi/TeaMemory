...
internal class HerbalTeaSuggestionsTest {
    ...
    fun getAmountTsSuggestion() {
        ...
        every { resources.getIntArray(R.array.new_tea_suggestions_herbal_tea_amount_ts) } returns arrayTs
    ...
    fun getAmountGrSuggestion() {
        ...
        every { resources.getIntArray(R.array.new_tea_suggestions_herbal_tea_amount_gr) } returns arrayGr
    ...
    fun getAmountTbSuggestion() {
        ...
        every { resources.getIntArray(R.array.new_tea_suggestions_herbal_tea_amount_tb) } returns arrayTb
    ...
    fun getTemperatureCelsiusSuggestion() {
        ...
        every { resources.getIntArray(R.array.new_tea_suggestions_herbal_tea_temperature_celsius) } returns arrayCelsius
    ...
    fun getTemperatureFahrenheitSuggestion() {
        ...
        every { resources.getIntArray(R.array.new_tea_suggestions_herbal_tea_temperature_fahrenheit) } returns arrayFahrenheit
    ...
    fun getSteepingTimeSuggestion() {
        ...
        every { resources.getStringArray(R.array.new_tea_suggestions_herbal_tea_time) } returns arrayTime
