...
public class CoolDownTimePickerDialogTest {
    ...
    public void showDialogAndExpectCalculatedCoolDownTime() {
        ...
        assertThat(textViewSuggestions.getText()).hasToString(dialogFragment.getString(R.string.newtea_dialog_cool_down_time_calculated_suggestion));
    ...
    public void clickCalculatedCoolDownTimeAndExpectShownCalculatedCoolDownTime() {
        ...
        final Button buttonSuggestion = dialog.findViewById(R.id.button_picker_suggestion_1);
